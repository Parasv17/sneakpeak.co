...
const SignupForm = () => {
  ...
  return (
    <>
      <div className="border-[1px] px-10 py-5 rounded-lg mx-auto dark:bg-gray-800 dark:border-gray-700 mb-10 text-lg ">
        <form
        ...
        >
          ...
          <div className="w-[30%]">
          <h2 className="text-2xl mb-4 text-center font-bold dark:text-white text-custom-blue">
              Personal Details
            </h2>
            <div className="mb-4">
              <Label
            ...
            <Button  className="mt-6 mx-auto " type="submit" variant={"submit"} disabled={submitting}>
            Sign In
          </Button>
          </div>
